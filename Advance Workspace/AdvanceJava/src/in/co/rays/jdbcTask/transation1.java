...
public static void main(String[] args) throws ClassNotFoundException, SQLException {
  ...
  try {
		...
		String s1 = "insert into empdetails (id,name,country,email) values(9,'Mark Ruffelo','USA','mark@gmail.com')";
		String s2 = "insert into empdetails (id,name,country,email) values(10,'Allu Arjun','India','allu@gmail.com')";
